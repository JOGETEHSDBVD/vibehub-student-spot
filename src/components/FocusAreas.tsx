...
const areas = [
  ...
  {
    icon: <Theater size={24} className="text-accent" />,
    bg: "bg-accent/10",
    title: "Arts & Culture",
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        {areas.map((a) => (
          <div key={a.title} className="rounded-2xl bg-background p-8 text-left shadow-sm transition-transform duration-200 hover:scale-[1.02]">
            ...
            <a href="#" className="mt-6 inline-flex items-center gap-1 text-sm font-medium text-foreground hover:text-accent transition-colors duration-200">
